...
{
    /// <summary>
    /// There are no comments for InventItemPriceSingle in the schema.
    /// </summary>
    [global::Microsoft.OData.Client.OriginalNameAttribute("InventItemPriceSingle")]
    public partial class InventItemPriceSingle : global::Microsoft.OData.Client.DataServiceQuerySingle<InventItemPrice>
    {
        /// <summary>
        /// Initialize a new InventItemPriceSingle object.
        /// </summary>
        public InventItemPriceSingle(global::Microsoft.OData.Client.DataServiceContext context, string path)
            : base(context, path) {}

        /// <summary>
        /// Initialize a new InventItemPriceSingle object.
        /// </summary>
        public InventItemPriceSingle(global::Microsoft.OData.Client.DataServiceContext context, string path, bool isComposable)
            : base(context, path, isComposable) {}

        /// <summary>
        /// Initialize a new InventItemPriceSingle object.
        /// </summary>
        public InventItemPriceSingle(global::Microsoft.OData.Client.DataServiceQuerySingle<InventItemPrice> query)
            : base(query) {}

    }
    /// <summary>
    /// There are no comments for InventItemPrice in the schema.
    /// </summary>
    /// <KeyProperties>
    /// DataAreaId
    /// ItemNumber
    ...
    /// </KeyProperties>
    [global::Microsoft.OData.Client.Key("dataAreaId", "ItemNumber", "CostingVersionId", "PriceType", "FromDate", "PriceSiteId", "ProductConfigurationId", "ProductColorId", "ProductSizeId", "ProductStyleId", "IsActive", "PriceCreatedDateTime")]
    [global::Microsoft.OData.Client.EntitySet("InventItemPrices")]
    [global::Microsoft.OData.Client.OriginalNameAttribute("InventItemPrice")]
    public partial class InventItemPrice : global::Microsoft.OData.Client.BaseEntityType, global::System.ComponentModel.INotifyPropertyChanged
    {
        /// <summary>
        /// Create a new InventItemPrice object.
        /// </summary>
        ...
        public static InventItemPrice CreateInventItemPrice(string dataAreaId, 
                    string itemNumber, 
        ...
        {
            InventItemPrice inventItemPrice = new InventItemPrice();
            inventItemPrice.DataAreaId = dataAreaId;
            inventItemPrice.ItemNumber = itemNumber;
            inventItemPrice.CostingVersionId = costingVersionId;
            inventItemPrice.FromDate = fromDate;
            inventItemPrice.PriceSiteId = priceSiteId;
            inventItemPrice.ProductConfigurationId = productConfigurationId;
            inventItemPrice.ProductColorId = productColorId;
            inventItemPrice.ProductSizeId = productSizeId;
            inventItemPrice.ProductStyleId = productStyleId;
            inventItemPrice.PriceCreatedDateTime = priceCreatedDateTime;
            inventItemPrice.PriceQuantity = priceQuantity;
            inventItemPrice.PriceChargesQuantity = priceChargesQuantity;
            inventItemPrice.Price = price;
            inventItemPrice.FixedPriceCharges = fixedPriceCharges;
