...
{
    /// <summary>
    /// There are no comments for CustomerPaymentInterestCodeSingle in the schema.
    /// </summary>
    [global::Microsoft.OData.Client.OriginalNameAttribute("CustomerPaymentInterestCodeSingle")]
    public partial class CustomerPaymentInterestCodeSingle : global::Microsoft.OData.Client.DataServiceQuerySingle<CustomerPaymentInterestCode>
    {
        /// <summary>
        /// Initialize a new CustomerPaymentInterestCodeSingle object.
        /// </summary>
        public CustomerPaymentInterestCodeSingle(global::Microsoft.OData.Client.DataServiceContext context, string path)
            : base(context, path) {}

        /// <summary>
        /// Initialize a new CustomerPaymentInterestCodeSingle object.
        /// </summary>
        public CustomerPaymentInterestCodeSingle(global::Microsoft.OData.Client.DataServiceContext context, string path, bool isComposable)
            : base(context, path, isComposable) {}

        /// <summary>
        /// Initialize a new CustomerPaymentInterestCodeSingle object.
        /// </summary>
        public CustomerPaymentInterestCodeSingle(global::Microsoft.OData.Client.DataServiceQuerySingle<CustomerPaymentInterestCode> query)
            : base(query) {}

    }
    /// <summary>
    /// There are no comments for CustomerPaymentInterestCode in the schema.
    /// </summary>
    /// <KeyProperties>
    /// DataAreaId
    /// InterestCode
    ...
    [global::Microsoft.OData.Client.EntitySet("CustomerPaymentInterestCodes")]
    [global::Microsoft.OData.Client.OriginalNameAttribute("CustomerPaymentInterestCode")]
    public partial class CustomerPaymentInterestCode : global::Microsoft.OData.Client.BaseEntityType, global::System.ComponentModel.INotifyPropertyChanged
    {
        /// <summary>
        /// Create a new CustomerPaymentInterestCode object.
        /// </summary>
        ...
        public static CustomerPaymentInterestCode CreateCustomerPaymentInterestCode(string dataAreaId, string interestCode, int gracePeriodDays, int interestCalculationPer, decimal interestPercentage)
        {
            CustomerPaymentInterestCode customerPaymentInterestCode = new CustomerPaymentInterestCode();
            customerPaymentInterestCode.DataAreaId = dataAreaId;
            customerPaymentInterestCode.InterestCode = interestCode;
            customerPaymentInterestCode.GracePeriodDays = gracePeriodDays;
            customerPaymentInterestCode.InterestCalculationPer = interestCalculationPer;
            customerPaymentInterestCode.InterestPercentage = interestPercentage;
            return customerPaymentInterestCode;
        }
        /// <summary>
