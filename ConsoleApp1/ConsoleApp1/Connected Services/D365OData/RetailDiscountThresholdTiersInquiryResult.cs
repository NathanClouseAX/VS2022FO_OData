...
{
    /// <summary>
    /// There are no comments for RetailDiscountThresholdTiersInquiryResultSingle in the schema.
    /// </summary>
    [global::Microsoft.OData.Client.OriginalNameAttribute("RetailDiscountThresholdTiersInquiryResultSingle")]
    public partial class RetailDiscountThresholdTiersInquiryResultSingle : global::Microsoft.OData.Client.DataServiceQuerySingle<RetailDiscountThresholdTiersInquiryResult>
    {
        /// <summary>
        /// Initialize a new RetailDiscountThresholdTiersInquiryResultSingle object.
        /// </summary>
        public RetailDiscountThresholdTiersInquiryResultSingle(global::Microsoft.OData.Client.DataServiceContext context, string path)
            : base(context, path) {}

        /// <summary>
        /// Initialize a new RetailDiscountThresholdTiersInquiryResultSingle object.
        /// </summary>
        public RetailDiscountThresholdTiersInquiryResultSingle(global::Microsoft.OData.Client.DataServiceContext context, string path, bool isComposable)
            : base(context, path, isComposable) {}

        /// <summary>
        /// Initialize a new RetailDiscountThresholdTiersInquiryResultSingle object.
        /// </summary>
        public RetailDiscountThresholdTiersInquiryResultSingle(global::Microsoft.OData.Client.DataServiceQuerySingle<RetailDiscountThresholdTiersInquiryResult> query)
            : base(query) {}

    }
    /// <summary>
    /// There are no comments for RetailDiscountThresholdTiersInquiryResult in the schema.
    /// </summary>
    /// <KeyProperties>
    /// DataAreaId
    /// OfferId
    ...
    [global::Microsoft.OData.Client.EntitySet("RetailDiscountThresholdTiersInquiryResults")]
    [global::Microsoft.OData.Client.OriginalNameAttribute("RetailDiscountThresholdTiersInquiryResult")]
    public partial class RetailDiscountThresholdTiersInquiryResult : global::Microsoft.OData.Client.BaseEntityType, global::System.ComponentModel.INotifyPropertyChanged
    {
        /// <summary>
        /// Create a new RetailDiscountThresholdTiersInquiryResult object.
        /// </summary>
        ...
        public static RetailDiscountThresholdTiersInquiryResult CreateRetailDiscountThresholdTiersInquiryResult(string dataAreaId, string offerId, decimal amountThreshold, decimal discountValue)
        {
            RetailDiscountThresholdTiersInquiryResult retailDiscountThresholdTiersInquiryResult = new RetailDiscountThresholdTiersInquiryResult();
            retailDiscountThresholdTiersInquiryResult.DataAreaId = dataAreaId;
            retailDiscountThresholdTiersInquiryResult.OfferId = offerId;
            retailDiscountThresholdTiersInquiryResult.AmountThreshold = amountThreshold;
            retailDiscountThresholdTiersInquiryResult.DiscountValue = discountValue;
            return retailDiscountThresholdTiersInquiryResult;
        }
        /// <summary>
