...
{
    /// <summary>
    /// There are no comments for LedgerJournalCostLinesPurchTableSingle in the schema.
    /// </summary>
    [global::Microsoft.OData.Client.OriginalNameAttribute("LedgerJournalCostLinesPurchTableSingle")]
    public partial class LedgerJournalCostLinesPurchTableSingle : global::Microsoft.OData.Client.DataServiceQuerySingle<LedgerJournalCostLinesPurchTable>
    {
        /// <summary>
        /// Initialize a new LedgerJournalCostLinesPurchTableSingle object.
        /// </summary>
        public LedgerJournalCostLinesPurchTableSingle(global::Microsoft.OData.Client.DataServiceContext context, string path)
            : base(context, path) {}

        /// <summary>
        /// Initialize a new LedgerJournalCostLinesPurchTableSingle object.
        /// </summary>
        public LedgerJournalCostLinesPurchTableSingle(global::Microsoft.OData.Client.DataServiceContext context, string path, bool isComposable)
            : base(context, path, isComposable) {}

        /// <summary>
        /// Initialize a new LedgerJournalCostLinesPurchTableSingle object.
        /// </summary>
        public LedgerJournalCostLinesPurchTableSingle(global::Microsoft.OData.Client.DataServiceQuerySingle<LedgerJournalCostLinesPurchTable> query)
            : base(query) {}

    }
    /// <summary>
    /// There are no comments for LedgerJournalCostLinesPurchTable in the schema.
    /// </summary>
    /// <KeyProperties>
    /// DataAreaId
    /// JournalNum
    ...
    /// </KeyProperties>
    [global::Microsoft.OData.Client.Key("dataAreaId", "JournalNum", "JournalLineNumber", "PurchaseOrderId", "CostTransactionLineNumber")]
    [global::Microsoft.OData.Client.EntitySet("LedgerJournalCostLinesPurchTables")]
    [global::Microsoft.OData.Client.OriginalNameAttribute("LedgerJournalCostLinesPurchTable")]
    public partial class LedgerJournalCostLinesPurchTable : global::Microsoft.OData.Client.BaseEntityType, global::System.ComponentModel.INotifyPropertyChanged
    {
        /// <summary>
        /// Create a new LedgerJournalCostLinesPurchTable object.
        /// </summary>
        ...
        public static LedgerJournalCostLinesPurchTable CreateLedgerJournalCostLinesPurchTable(string dataAreaId, 
                    string journalNum, 
                    ...
                    decimal amount)
        {
            LedgerJournalCostLinesPurchTable ledgerJournalCostLinesPurchTable = new LedgerJournalCostLinesPurchTable();
            ledgerJournalCostLinesPurchTable.DataAreaId = dataAreaId;
            ledgerJournalCostLinesPurchTable.JournalNum = journalNum;
            ledgerJournalCostLinesPurchTable.JournalLineNumber = journalLineNumber;
            ledgerJournalCostLinesPurchTable.PurchaseOrderId = purchaseOrderId;
            ledgerJournalCostLinesPurchTable.CostTransactionLineNumber = costTransactionLineNumber;
            ledgerJournalCostLinesPurchTable.Amount = amount;
            return ledgerJournalCostLinesPurchTable;
        }
        /// <summary>
